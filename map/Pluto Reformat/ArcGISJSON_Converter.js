...
//There are two variations at the end. 
//One saves to a .JSON file the other saves as the JSON to a JS variable. 
//The name of the object is declared in the function. 
...
//this functions writes a JS file with data stored in variable. 
    deserialize(arcGISJSON, (function (theJSON) { 
            var objectName = "bushwickJSON";
            var objectCode = "var " + objectName + " = ";
