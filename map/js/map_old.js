...
function pop_pluto(feature, layer) {
	var popupContent = '<div style="text-align: center;"><strong>Property information</strong>' + 
							'</div><table><tr><td>Address</td><td>' + feature.properties.Address +
							'</td></tr><tr><td>Owner Name</td><td>' + feature.properties.OwnerName + 
							'</td></tr><tr><td>Lot Area</td><td>' + feature.properties.LotArea +
							' Sq. Feet' + '</td></tr><tr><td>Floors</td><td>' + feature.properties.NumFloors + 
							'</td></tr><tr><td>Residential Units</td><td>' + '  ' +feature.properties.UnitsRes + 
							'</td></tr><tr><td>Year Built</td><td>' + feature.properties.YearBuilt + 
							'</td></tr><tr><td>Built FAR</td><td>' + feature.properties.BuiltFAR + 
							'</td></tr><tr><td>Max Res FAR</td><td>' + feature.properties.ResidFAR + 
							'<tr><td>Land Use</td><td>' + LandUse_function(feature.properties.LandUse) + 
							'</td></tr></table>' + 
							'<p><a target="_blank" href="http://a836-acris.nyc.gov/bblsearch/bblsearch.asp?borough=3&block=' + 
							feature.properties.Block + '&lot=' + feature.properties.Lot + '">Click here for ACRIS information</a>';
